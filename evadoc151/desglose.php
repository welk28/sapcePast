				...
				{		
						...
						{	
							...
							<tr>
								<td>$pr->nop</td>
								<td>$pr->pregunta</td>
								<td class='resul'>$pr->uno <br>"; $r1=($pr->uno*$mo->p1)/$do->num;  $sumr+=$r1; printf("%0.2f",$r1); echo"</td>
								<td class='resul'>$pr->dos <br>"; $r2=($pr->dos*$mo->p2)/$do->num;  $sumr+=$r2; printf("%0.2f",$r2); echo"</td>
								<td class='resul'>$pr->tre <br>"; $r3=($pr->tre*$mo->p3)/$do->num;  $sumr+=$r3; printf("%0.2f",$r3); echo"</td>
								<td class='resul'>$pr->cua <br>"; $r4=($pr->cua*$mo->p4)/$do->num;  $sumr+=$r4; printf("%0.2f",$r4); echo"</td>
								<td class='resul'>$pr->cin <br>"; $r5=($pr->cin*$mo->p5)/$do->num;  $sumr+=$r5; printf("%0.2f",$r5); echo"</td>
