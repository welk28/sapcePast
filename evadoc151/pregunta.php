...
<div id="cuerpo">
	<header id="cabecera">
		...
		if($op==1)
		{
			...
			$numero="select uno from respuesta where idh='$idh' and nop='$noev';";
			$num=mysql_query($numero,$conexion);
			$nu=mysql_fetch_object($num);
			$n=$nu->uno+1;

			$acrespuesta="update respuesta set uno='$n' where idh='$idh' and nop='$noev';";
			$acres=mysql_query($acrespuesta);
			//echo"numero pregunta a guardar: $n <br> idh: $idh";
			if($acres)
			{
				if($noev==48)
				{
		...
		if($op==2)
		{
			...
			$numero="select dos from respuesta where idh='$idh' and nop='$noev';";
			$num=mysql_query($numero,$conexion);
			$nu=mysql_fetch_object($num);
			$n=$nu->dos+1;

			$acrespuesta="update respuesta set dos='$n' where idh='$idh' and nop='$noev';";
			$acres=mysql_query($acrespuesta);
			//echo"numero pregunta a guardar: $n <br> idh: $idh";
			if($acres)
			{
		...
		if($op==3)
		{
			...
			$numero="select tre from respuesta where idh='$idh' and nop='$noev';";
			$num=mysql_query($numero,$conexion);
			$nu=mysql_fetch_object($num);
			$n=$nu->tre+1;

			$acrespuesta="update respuesta set tre='$n' where idh='$idh' and nop='$noev';";
			$acres=mysql_query($acrespuesta);
			//echo"numero pregunta a guardar: $n <br> idh: $idh";
			if($acres)
			{
		...
		if($op==4)
		{
			...
			$numero="select cua from respuesta where idh='$idh' and nop='$noev';";
			$num=mysql_query($numero,$conexion);
			$nu=mysql_fetch_object($num);
			$n=$nu->cua+1;

			$acrespuesta="update respuesta set cua='$n' where idh='$idh' and nop='$noev';";
			$acres=mysql_query($acrespuesta);
			//echo"numero pregunta a guardar: $n <br> idh: $idh";
			if($acres)
			{
		...
		if($op==5)
		{
			...
			$numero="select cin from respuesta where idh='$idh' and nop='$noev';";
			$num=mysql_query($numero,$conexion);
			$nu=mysql_fetch_object($num);
			$n=$nu->cin+1;

			$acrespuesta="update respuesta set cin='$n' where idh='$idh' and nop='$noev';";
			$acres=mysql_query($acrespuesta);
			//echo"numero pregunta a guardar: $n <br> idh: $idh";
			if($acres)
			{
