	...
	if(($ses==1)||($ses==6))
{
    ...
    <header id="header">
	  <div id="revision">
	   ...
	   <div class="subtitulo" align="center">PROGRAMA ANUAL DE ENCUESTAS Y SERVICIOS</div>
        <br>
				<?php 
				$servicio="select * from servicio s, auditoria a where a.idser=s.idser and a.noev='$noev'";
				$serv=mysql_query($servicio,$conexion);
				$se=mysql_fetch_object($serv);
				echo"<div class='subtitulo' align='center'>$se->descs</div>";
				?>
    </header>
    ...
    <div id="registros" >
    	<table>
			<tr>
				...
				<th width="" align="center">NOMBRE DEL ALUMNO</th>
		   ...
		   else 
		   {
			   ...
			   echo"<tr>
					...
					<td align='center'>$s->idcar</td>
					<td align=''>$s->nom  $s->app $s->apm</td>
