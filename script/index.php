...
<body class="container text-center">
	...
	<div class="row mt-3"> 
		<div class="col-md-12">
			<a href="sapce.php" target="_blank" class="btn btn-outline-primary btn-lg btn-block">Sapce</a>
		</div>
	</div>
	<div class="row mt-1"> 
		<div class="col-md-12">
	...
	<div class="row mt-5">
		<div class="col-md-3">
			...
			<div class="row">
				<div class="col-md-12">
					<p> administrador<br> control<br> carrera<br> materias<br> 	posee<br>	alumnos <br>especialidad </p>
				</div>
			</div>
		</div>
		<div class="col-md-3">
			...
			<div class="row">
				<div class="col-md-12">
					<p>
					periodo<br>	depto<br>adeuda<br>academico<br>aula<br>coordinador<br>coordina<br>servicio<br>docente<br>coordinaser<br>horario<br>division<br>grupo<br>hgrupo<br>imparte<br>encarre<br>encarga<br>oportuniad<br>certificado
					</p>
				</div>
			</div>
		</div>
		<div class="col-md-3">
			...
			<div class="row">
				<div class="col-md-12">
					<p>Primera mitad de registros CURSA</p>
				</div>
			</div>
		</div>
		<div class="col-md-3">
			<a href="04parte.php" target="_blank" class="btn btn-primary">Cuarta parte</a>
			<div class="row">
				<div class="col-md-12">
					<p>
						Segunda mitad de registros CURSA
					</p>
				</div>
			</div>
		</div>
