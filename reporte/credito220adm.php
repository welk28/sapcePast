...
<div id="cuerpo">
    ...
    <header id="header">
			...
			<div class="subtitulo">Lista de alumnos ADMINISTRACION 220 CREDITOS EN ADELANTE <?php echo"$periodo: $p->descper"?></div>
    ...
    <table>
		...
		$alumnos="select distinct a.matricula, a.curp, a.app, a.apm, a.nom, a.status, a.propre, a.fecnac, a.sexo, a.idcar, a.email  from alumnos as a, horario as h, cursa as c where h.idh=c.idh and a.matricula=c.matricula and a.idcar='IADM-2010-213' order by a.idcar, a.status;";
