...
<div id="cuerpo">
    ...
    <table>
        ...
        <?php
		$alumnos="select distinct a.matricula, a.curp, a.app, a.apm, a.nom, a.status, a.propre, a.fecnac, a.sexo, a.idcar, a.email, a.discap  from alumnos as a, horario as h, cursa as c where h.idh=c.idh and a.matricula=c.matricula and a.idcar='IADM-2010-213' and h.periodo='$periodo' order by a.idcar, a.status;";
