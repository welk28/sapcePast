...
<div id="cuerpo">
    ...
    <table>
        ...
        <?php
		$alumnos="select distinct a.matricula, a.curp, a.telal, a.app, a.apm, a.nom, a.status, a.propre, a.fecnac, a.sexo, a.idcar, a.email, a.discap  from alumnos as a, horario as h, cursa as c where h.idh=c.idh and a.matricula=c.matricula and a.idcar='ITIC-2010-225' and h.periodo='$periodo' order by a.idcar, a.status;";
		...
		while($a=mysql_fetch_object($als))
		{
			...
			<tr>			
				...
				{ 
					...
					{
						$historia="select * from horario as h, cursa as c, materias as m where h.idmat=m.idmat and  h.idh=c.idh and matricula='$a->matricula' and h.idmat='$mc->idmat' and h.periodo='2020-2' order by h.periodo;";
