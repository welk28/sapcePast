...
<div id="cuerpo">
    ...
    <header id="header">
			<div class="subtitulo">Lista de alumnos TICS 208 CREDITOS EN ADELANTE <?php echo"$periodo: $p->descper"?></div>
        <br>
    </header>
    ...
    <table>
        ...
        <?php
		$alumnos="select distinct a.matricula, a.curp, a.app, a.apm, a.nom, a.status, a.propre, a.fecnac, a.sexo, a.idcar, a.email  from alumnos as a, horario as h, cursa as c where h.idh=c.idh and a.matricula=c.matricula and a.idcar='ITIC-2010-225' and h.periodo='$periodo' and a.status>1 order by a.idcar, a.status;";
