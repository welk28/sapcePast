	...
	if(($ses==1)||($ses==6))
{
    ...
    <div id="registros" >
    	<div class="subtitulo">Lista de procedencia de alumnos de forma general (Historia) </div>
        <br>
    	<?php
    	...
    	while($p=mysql_fetch_object($pro))
    	{
		    ...
		    <table>
				...
				$alumnos="select distinct a.matricula, a.app, a.apm, a.nom, a.prepa, a.otesc, a.sexo, a.status, a.idcar  from alumnos as a where a.idesc='$p->idesc' order by a.idcar, a.matricula;";
