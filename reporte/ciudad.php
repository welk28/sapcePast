...
echo"
	<table >
	  <tr>
		<th><h3>ALUMNOS DE NUEVO INGRESO <br />
	...
	<tr>
	  ...
	  {
  		$x++;
		$cant="select distinct c.matricula from cursa as c, alumnos as a, horario as h where h.idh=c.idh and a.matricula=c.matricula and a.status='1' and h.periodo='$periodo' and a.idcar='$car->idcar' and  a.idedo='$e->idedo';";
