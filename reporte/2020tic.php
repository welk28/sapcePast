...
<div id="cuerpo">
    ...
    <header id="header">
			<div class="subtitulo">ING. TICS inscritos en el semestre actual <?php echo"$periodo: $p->descper"?></div>
        <br>
    </header>
    ...
    <table>
        ...
        <?php
		$alumnos="select distinct a.matricula, a.curp, a.app, a.apm, a.nom, a.status, a.telal, a.propre, a.fecnac, a.sexo, a.idcar, a.email  from alumnos as a, horario as h, cursa as c where h.idh=c.idh and a.matricula=c.matricula and a.idcar='ITIC-2010-225' and h.periodo='$periodo' order by a.idcar, a.status;";
