...
<div id="cuerpo">
    ...
    <table>
    	...
    	<tr>
			...
			if($ses==2)echo"<th width='43' colspan='2'>Avance</th>"; ?>
            ...
            <th width='42'>Kardex <br>actual</th>

            <th width='42'>Histo anterior</th>
			<th width='42'>Certifi</th>
...

		{
			...
			<tr>
				...
				{echo"<td><a href='../reporte/avance.php?matricula=$a->matricula' target='_blank' title='Avance semestre anterior de $a->nom'>Antes</a></td>

						<td><a href='../reporte/avanceactual.php?matricula=$a->matricula' target='_blank' title='Avance semestre actual de $a->nom'>Actual</a></td>";}
				...
				//{
					...
					<td align='center'><a href='certificadoform.php?matricula=$a->matricula' target='_blank' title='CERTIFICADO de $a->nom'>Ver</a></td>
