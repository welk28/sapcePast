...
<div id="cuerpo">
    ...
    <div id="certificado" >
      <table border='1'> <!--LATERAL IZQUIERDO PRINCIPAL -->
        <tr>
          <td width="250" >
            <table border='1'> <!--LATERAL IZQUIERDO FIRMA DE INTERESADO -->
              <tr>
                
                <td height="850" width="30"></td>
              </tr>
              <tr>
            ...
            <table>
              <tr>
                ...
                <td colspan="3" style="text-align: justify;"> <br><br><br>
                  ...
                  <?php if($ad->sexo=='M') echo" LA "; else echo" EL "; ?> C. <u><b><?php echo"$ad->app $ad->apm $ad->nom"; ?></b></u>, CON CURP <u><b><?php echo"$ad->curp"; ?></b></u>, CURSÓ LAS ASIGNATURAS QUE INTEGRAN EL PLAN DE ESTUDIOS DE <u><b><?php echo"$ad->descar"; ?></b></u> (PLAN-CRÉDITOS) DE <u><b><?php echo"$ft->periodo"; ?>. <br> CON LOS RESULTADOS QUE A CONTINUACIÓN SE ENLISTAN.</b></u> <br><br><br>
                </td>

              </tr>
              <tr>
                <!-- EL TOTAL DEBE DSER DE 730px-->
                <th width="450"></th><!-- NOMBRE DE MATERIAS -->
                <th width="120"></th><!-- CALIF 1-->
                <th width="130"></th>   <!-- CALIF 2 incrementar para alinear o ajustar -->
              </tr>
              <?php
              $sumcred=0;
              $sumpro=0;
      //$matecar="select * from posee where idcar='$ad->idcar' order by sem;";
            ...
            <td colspan='3' style='text-align: justify;'><br><br><br><br>
            ...
            <td colspan='3' align='center'>ING. HUGO ERNESTO CUELLAR CARREÓN <br> DIRECTOR</td>
            </tr>
            </table>";
