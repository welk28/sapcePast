...
<table>
        ...
        <?php
            ...
            {	echo"<tr>";				
				...
				if($c<=$nt)
				{
					...
					if($nm>0) //sí encontró
					{
						if(($hc->prom<70)&&($hc->periodo!=$periodo))//si la materia encontrada no es del periodo actual y ademas es reprobatorio, colocarlo como reprobado
						{
							...
							if(($hc->opor==1)||(($hc->opor==4)))
							{echo"<p class='reprobo'>A Repetición</p>";}
							else
							{
								if(($hc->opor==2)||($hc->opor==2))
				...
				$ret1="select p.idmat, m.nommat, m.cred, m.credit, m.idesp, m.habil from posee as p, materias as m where p.idcar='$idcar' and p.idmat=m.idmat and p.sem='7' and m.habil='1'and  not exists (select ma.idmat from materias as ma where ma.idesp<>'NULL' and m.idmat=ma.idmat) order by p.idmat limit $a,1;";



				//$ret1="select p.idmat, m.nommat, m.cred, m.credit, m.idesp, m.habil from posee as p, materias as m where p.idcar='$idcar' and p.idmat=m.idmat and p.sem='7' and m.habil='1' order by p.idmat limit $a,1;";
				...
				$ret1="select p.idmat, m.nommat, m.cred, m.credit, m.idesp, m.habil from posee as p, materias as m where p.idcar='$idcar' and p.idmat=m.idmat and p.sem='8' and m.habil='1'and  not exists (select ma.idmat from materias as ma where ma.idesp<>'NULL' and m.idmat=ma.idmat) order by p.idmat limit $a,1;";



				//$ret1="select p.idmat, m.nommat, m.cred, m.credit, m.idesp, m.habil from posee as p, materias as m where p.idcar='$idcar' and p.idmat=m.idmat and p.sem='8' and m.habil='1' order by p.idmat limit $a,1;";
				...
				$ret1="select p.idmat, m.nommat, m.cred, m.credit, m.idesp, m.habil from posee as p, materias as m where p.idcar='$idcar' and p.idmat=m.idmat and p.sem='9' and m.habil='1'and  not exists (select ma.idmat from materias as ma where ma.idesp<>'NULL' and m.idmat=ma.idmat) order by p.idmat limit $a,1;";



				//$ret1="select p.idmat, m.nommat, m.cred, m.credit, m.idesp, m.habil from posee as p, materias as m where p.idcar='$idcar' and p.idmat=m.idmat and p.sem='9' and m.habil='1' order by p.idmat limit $a,1;";
