...
<div id="cuerpo">
    ...
    <header id="header">
			...
			<div class="subtitulo2">Lista de alumnos en CURSO Semi Presencial en el semestre actual <?php echo"$periodo: $p->descper"?></div>
	...
	<table>
		...
		$alumnos="select c.matricula, a.app, a.apm, a.nom, a.status, a.idcar, h.idmat, m.nommat from horario as h, materias as m, alumnos as a, cursa as c where h.idmat=m.idmat and h.idh=c.idh and c.matricula=a.matricula and h.periodo='$periodo' and c.opor='6' and a.idcar='$ca->idcar' order by a.matricula desc;";
