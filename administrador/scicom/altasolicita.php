...
$nfol=$a.$def.$f.$fol;
		...
		<section id="seccion">
			...
			<article id="form">
				<div align="center">
				<form  name="altasolicita" id="altasolicita" action="altasolicita2.php" method="get">
  ...
  <tr>
    ...
    <td width="341"> 
	<input type="text" value="<?php echo"$c->nomdoc";?>" size="50" disabled="disabled">
	<input type="hidden" id="clave" name="clave" value="<?php echo"$clave";?>" size="50">
	</td>
  </tr>
  <tr>
