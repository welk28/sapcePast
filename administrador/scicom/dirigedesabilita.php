...
if (pregunta==true)
{
document.dirigedesabilita.submit();
		/*alert('DESABILITADO');*/
...
<body>
	<div id="cuerpo">
		...
		<?php include"../../usuarios.php"; 
		 ...
		 $subconsulta="select * from oficina where idoficina='$idoficina';";
		...
		<section id="seccion">
			...
			<article id="form">
			<div align="center">
			<form name="dirigedesabilita" id="dirigedesabilita" action="dirigedesabilita2.php" method="get">
