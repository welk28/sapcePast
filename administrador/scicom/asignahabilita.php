...
{
var pregunta= confirm("ESTA SEGURO QUE DESEA HABILITAR")
...
<body>
	...
	$fechafin= date("Y-m-d");
		...
		<section id="seccion">
			<header id="header">
				<div class="subtitulo">Habilita al Docente  su Equipo:</div>
			</header>
			<article id="form">
			<div align="center">
			<form action="asignahabilita2.php" id="asignadesabilita" name="asignadesabilita" method="post">
	<table width="252" border="1" align="center">
  <tr>
    <td colspan="2"><div align="center">HABILITA</div></td>
    </tr>
  <tr>
