...
<div id="cuerpo">
	...
	<section id="seccion">
        ...
        <header id="header">
                <div class="subtitulo">Lista de Docentes Evaluación Docente en el periodo <?php echo": $perevadoc ";?></div>
            <br>
        </header>
    ...
    <table>
        ...
        <?php
		$docente=" select distinct d.idoc, d.nomdoc  from docente as d, horario as h where h.idoc=d.idoc and h.periodo='$perevadoc';";
