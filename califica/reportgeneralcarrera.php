      ...
      <div id="registrosrep" >
        ...
        <table>
            ...
            <?php
              ...
              $lasmaterias="select m.idmat, h.idh, m.nommat, c.idcar, c.descar from materias as m, carrera as c, posee as p, horario as h where p.idcar=c.idcar and p.idmat=m.idmat and h.idmat=m.idmat and h.periodo='$periodo' and c.idcar='ITIC-2010-225' order by m.nommat, h.idh;";
