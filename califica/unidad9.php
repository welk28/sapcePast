...
<table>
  <tr>
	...
	<!--<th width="80px" rowspan="2">Control</th>-->
...
/*PARA SEPTIMA UNIDAD*/
  ...
  {echo"   
   ...
   /*PARA NOVENA UNIDAD*/
    echo"<td align='center'><input class='cals' name='po9' type='text'  id='po9' size='3' maxlength='3' onkeypress='javascript:if(event.KeyCode <48 || event.keyCode >57){return false;}' ";if($rp->po9==0 && $rp->po9!=NULL) echo"value='' placeholder='NA'"; else  echo"value='$rp->po9'"; echo" />  </td>";
  
  
  //_________________________________________________________________________________________
  //VERIFICAR SI OPORTUNIDAD 1 ES NULO O DIFERENTE DE 0, DESACTIVAR SEGUNDA OPORTUNIDAD
  if($rp->po9==NULL || $rp->po9!=0 )
  {echo"   
    <td align='center' >
    <input class='cals' name='so9' type='text'  size='3' maxlength='3' onkeypress='javascript:if(event.KeyCode <48 || event.keyCode >57){return false;}' "; if($rp->so9==0 && $rp->so9!=NULL)echo"value='' placeholder='NA'"; else echo"value='$rp->so9'";echo"  disabled='disabled'/>
    </td>";
  }
  else
  {echo"   
    <td align='center' ><input class='cals' name='so9' type='text' size='3' maxlength='3' onkeypress='javascript:if(event.KeyCode <48 || event.keyCode >57){return false;}' "; if($rp->so9==0 && $rp->so9!=NULL)echo"value='' placeholder='NA'"; else echo"value='$rp->so9'";echo"  /></td>";
  }
