...
<div id="cuerpo">
    ...
    print"
        ...
        alert('NO TIENE MATERIAS EN EL DEPARTAMENTO DE INGENIERIAS $periodo $idoc');
      ...
      <div id="registrosrep" >
        ...
        <table>
            ...
            <?php
              ...
              $lasmaterias="select m.idmat, h.idh, m.nommat, c.idcar, c.descar from materias as m, carrera as c, posee as p, horario as h where p.idcar=c.idcar and p.idmat=m.idmat and h.idmat=m.idmat and h.periodo='$periodo' and idoc='$idoc' and m.depto='$depto' order by m.nommat;";
