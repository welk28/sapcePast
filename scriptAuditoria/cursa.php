...
$consulta="select * from cursa c, horario h where c.idh=h.idh and h.periodo='$periodo'";
...
$consulta="select * from cursa c, horario h where h.idh=c.idh and h.periodo='$periodo';";
$cons=mysql_query($consulta,$conexion);
$fin=mysql_num_rows($cons);
