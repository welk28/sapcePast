...
$band=$_GET[band];
    ...
    <header id="header">
			<div class="subtitulo">Lista de alumnos bloqueados HISTORICAMENTE por el presente departamento </div>
        <br>
    </header>
   ...
   <table> 
			...
			<?php 
				$alumnosd="select a.matricula, a.app, a.apm, a.nom, a.status as sem, a.idcar, d.fecha, d.descrip, d.periodo, d.status as sta from alumnos as a, adeuda as d where a.matricula=d.matricula and d.iddepto='$usuario' order by d.status";
