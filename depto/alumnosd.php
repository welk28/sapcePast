	...
	if(($ses==1)||($ses==6))
{
    ...
    <table>
        ...
        <?php
		$alumnos="select distinct a.matricula, a.app, a.apm, a.nom, a.status, a.fecnac, a.sexo, a.idcar  from alumnos as a, horario as h, cursa as c where h.idh=c.idh and a.matricula=c.matricula and h.periodo='$periodo' and h.idmat='SS' order by a.idcar, a.status;";
		...
		while($a=mysql_fetch_object($als))
		{
			...
			<tr>
				...
				<td> <a href='../reporte/kardex.php?matricula=$a->matricula' target='_blank' title='KARDEX de $a->nom'>$a->app $a->apm $a->nom</a></td>
				...
				echo"<td align='center'><a href='historial.php?matricula=$a->matricula' target='_blank' title='HISTORIAL de $a->nom'>Ver</a></td>
