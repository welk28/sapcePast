...
$band=$_GET[band];
   ...
   <table> 
			...
			<?php 
				$alumnosd="select a.matricula, a.app, a.apm, a.nom, a.status as sem, a.idcar, d.fecha, d.iddepto, d.descrip, d.periodo, d.status as sta from alumnos as a, adeuda as d where a.matricula=d.matricula order by d.status";
