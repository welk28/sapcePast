...
$band=$_GET[band];
    ...
    <table> 
			...
			<?php 
				$alumnosd="select a.matricula, a.app, a.apm, a.nom, a.status, a.idcar, d.fecha, d.descrip from alumnos as a, adeuda as d where a.matricula=d.matricula and d.status='1' and d.iddepto='$usuario' and d.periodo='$periodo';";
				...
				while($d=mysql_fetch_object($alumd))
				{
					$x++;
					echo" 
					<form action='bloqueados.php' method='get'>
					<tr>
						<td>$x</td>
						...
						<td align='center' ><input class='guardacal' type='image' name='Submit' value='Submit' src='$ip/img/hecho.png' width='20' height='20' title='Desloquear'></td>
					</tr></form>";
				}
			?>
